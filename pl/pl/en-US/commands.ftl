...
cmd-cldbglyr-help =
    Usage: { $command } <layer>: Toggle <layer>
...
cmd-bind-help =
    Usage: { $command } { cmd-bind-arg-key } { cmd-bind-arg-mode } { cmd-bind-arg-command }
...
cmd-testlog-help =
    Usage: { $command } <sawmill> <level> <message>
